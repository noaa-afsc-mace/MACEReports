...
plot_biomass_nums_by_age <- function(age_vector, biomass_vector, numbers_vector, add_totals = FALSE){
    ...
    make_base_plot <- function() {
      ...
      graphics::mtext(side = 4, line = 2.5, "Biomass (1000s t)", cex = 1.0, padj = 1, family = "Times", col = "#cb181d")
      graphics::mtext(side = 2, line = 4.5, "Numbers of fish (millions)", cex = 1.0, padj = 1, family = "Times", col = "#0072B2")
      graphics::mtext(side = 1, line = 2, "Age", cex = 1.0, padj = 1, family = "Times")
