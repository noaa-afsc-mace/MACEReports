#' @title build_shelikof_pre_selectivity_corrected_num_age_table
#'
...
#' available, the data is available within MACEReports package: see \code{shelikof_historic_numbers_by_age_1981_to_2007}.
#'
...
build_shelikof_pre_selectivity_corrected_num_age_table = function(){
  ...
  #build the caption
  cap_text = paste0('Numbers-at-age estimates (millions of fish) from acoustic-trawl surveys of walleye pollock in the ',
