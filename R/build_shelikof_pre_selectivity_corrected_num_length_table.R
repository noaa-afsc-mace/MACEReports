...
#' shelikof_historical_num_length_list = build_shelikof_pre_selectivity_corrected_num_length_table()
#'
#' # pull out the table and caption from the list
#' shelikof_historical_num_length_table = shelikof_historical_num_length_list[[1]]
#' shelikof_historical_num_length_caption = shelikof_historical_num_length_list[[2]]
#'
#' }
#' @export
build_shelikof_pre_selectivity_corrected_num_length_table = function(){
  ##############
  #1. Numbers-at-length table
  ...
  nums_length_table = flextable::flextable(shelikof_historic_numbers_by_length_1981_to_2007)%>%
   ...
   nums_length_table = flextable::hline(nums_length_table,
                                        i = nums_length_table$body$content$content$nrow -1, part = 'body',
                                        border = table_border)
  ...
  years_for_caption = as.numeric(colnames(shelikof_historic_numbers_by_length_1981_to_2007
                               [2:length(colnames(shelikof_historic_numbers_by_length_1981_to_2007))]))
  #build the caption
  cap_text = paste0('Numbers-at-length estimates (millions of fish) from acoustic-trawl surveys of walleye pollock in the ',
