...
build_shelikof_pre_selectivity_corrected_num_age_table <- function() {
  ...
  shelikof_historic_numbers_by_age_1981_to_2007 <- MACEReports::shelikof_historic_numbers_by_age_1981_to_2007
  ...
  # build the caption
  cap_text <- paste0(
    "Numbers-at-age estimates (millions of fish) from acoustic-trawl surveys of pollock in the ",
