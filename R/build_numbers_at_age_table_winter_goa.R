#' @title build_numbers_at_age_table_winter_goa
#'
...
build_numbers_at_age_table_winter_goa = function(biomass_nums_age_data, region_name){
  ...
  nums_age_table = flextable::flextable(nums_by_age_selectivity_corrected)%>%
    ...
    flextable::width(width = 10/ncol(nums_by_age_selectivity_corrected))%>%
  ...
  cap_text = paste0('Numbers-at-age estimates (millions of fish) from acoustic-trawl surveys ',
